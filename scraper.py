...
headers = ["star", "constellation", "right_ascension", "declination", "apparent_magnitude", "distance", 
            "spectral_type", "brown_dwarf", "mass", "radius","orbital_period","semimajor axis","Eccnetricity","discovery date" ]
